  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in space-y-6 pb-24">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-slate-900">Learn: How to Handle Complaints Professionally</h2>
        <p className="mt-2 text-lg text-slate-600">Turn difficult situations into opportunities using the L.A.S.T. method.</p>
      </div>
      ...
      <div className="space-y-6">
        <Card title="Step 1: L - Listen">
          <div className="p-4 text-slate-700 space-y-2 text-sm">
            <h3 className="text-lg font-semibold text-blue-600">Goal: Understand the Full Picture</h3>
        ...
        <Card title="Step 2: A - Acknowledge & Apologize">
          <div className="p-4 text-slate-700 space-y-2 text-sm">
            <h3 className="text-lg font-semibold text-blue-600">Goal: Show Empathy and Validate Their Feelings</h3>
        ...
        <Card title="Step 3: S - Solve">
          <div className="p-4 text-slate-700 space-y-2 text-sm">
            <h3 className="text-lg font-semibold text-blue-600">Goal: Take Ownership and Propose a Solution</h3>
        ...
        <Card title="Step 4: T - Thank">
          <div className="p-4 text-slate-700 space-y-2 text-sm">
            <h3 className="text-lg font-semibold text-blue-600">Goal: Rebuild the Relationship</h3>
