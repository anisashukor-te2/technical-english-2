                ...
                <Card title="Meeting & Minute-Taking Sessions">
                    {isLoading ? (
                        ...
                        <div className="p-8 text-center">
                            ...
                            <button onClick={fetchSessions} className="bg-slate-700 hover:bg-slate-600 text-white font-bold py-2 px-6 rounded-lg">Retry</button>
                        </div>
                    ) : sessions.length === 0 ? (
                                ...
                                <div key={session.id} className="p-3 bg-slate-900/50 rounded-lg flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-400">
                                            ...
                                            Completed: {new Date(session.timestamp).toLocaleString()}</p>
