  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in space-y-6 pb-24">
            ...
            <Card key={index} title={`Question ${index + 1}: ${isCorrect ? 'Correct' : 'Incorrect'}`}>
              <div className="p-4 space-y-3">
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg text-xs">
                    <p className="font-semibold text-cyan-400 mb-1">Explanation</p>
      ...
      <div className="text-center pt-4 space-x-4">
        <button onClick={onRetake} className="bg-cyan-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-cyan-700 transition-colors">
          Retake Quiz
        </button>
        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-4 border-t border-slate-700 flex justify-between items-center">
            ...
            {isLastQuestion ? (
              ...
              <button onClick={handleNext} disabled={selectedAnswer === null} className="bg-cyan-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-cyan-700 disabled:opacity-50">
                Next
              </button>
            )}
          </div>
