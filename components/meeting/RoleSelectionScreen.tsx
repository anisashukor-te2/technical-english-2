...
const RoleCard: React.FC<{ role: string; onSelect: () => void }> = ({ role, onSelect }) => (
    <div
        onClick={onSelect}
        className="w-64 bg-white border border-slate-200 rounded-lg p-6 cursor-pointer hover:bg-slate-50 hover:border-blue-500 transition-all transform hover:-translate-y-1 flex flex-col items-center justify-center text-center shadow-lg"
    >
        ...
        <p className="mt-2 text-slate-600 text-sm">Practice as the {role}. The AI will play all other roles.</p>
    </div>
);
    ...
    return (
        <div className="max-w-5xl mx-auto animate-fade-in">
            <div className="text-center mb-8">
                ...
                <p className="mt-2 text-lg text-slate-600">Scenario: <span className="text-blue-600 font-semibold">{scenario.title}</span></p>
            </div>
