...
export const MinuteFeedbackDisplay: React.FC<MinuteFeedbackDisplayProps> = ({ feedback, userMinutes, onPracticeAgain, onBack, title = "Feedback", sessionId, isStudent, isLecturerView = false, sessionData }) => {
    ...
    const handleSubmitToLecturer = async () => {
        ...
        try {
            await firebaseService.updateSession('minuteTakingSessions', sessionId, { isSubmitted: true });
            setIsSubmitted(true);
    ...
    const handleSaveLecturerFeedback = async () => {
        ...
        try {
            await firebaseService.saveMinuteTakingLecturerFeedback(currentSessionId, Number(grade), lecturerFeedback.trim());
           ...
           <Card title="Lecturer's Feedback">
               <div className="p-4 space-y-4">
                   ...
                   <div>
                       ...
                       <blockquote className="p-3 bg-slate-700/50 border-l-4 border-cyan-500 text-white italic text-sm">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                    ...
                    {isStudent && (
                        <button
                            ...
                            className="bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-4 focus:ring-blue-500/50 text-sm disabled:bg-slate-600 disabled:cursor-not-allowed"
                        >
