...
const PlaceholderScreen: React.FC<PlaceholderScreenProps> = ({ moduleName }) => {
  return (
    <div className="max-w-4xl mx-auto flex flex-col items-center justify-center h-[calc(100vh-300px)] text-center bg-white/60 border border-white/30 rounded-lg p-8 animate-fade-in shadow-lg">
